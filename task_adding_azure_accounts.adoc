...
+
** 애플리케이션 ID: 을 참조하십시오  the application ID and directory ID.
** 테넌트 ID(또는 디렉터리 ID): 을 참조하십시오  the application ID and directory ID.
** 응용 프로그램 키(클라이언트 암호): 을 참조하십시오  a client secret.
